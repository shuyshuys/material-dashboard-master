        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                ...
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a href="https://igsitconsultant.000webhostapp.com/" class="btn btn-sm bg-gradient-primary mb-0"
                            onclick="smoothToPricing('pricing-soft-ui')">Main Pages</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form role="form" class="text-start" method="post" name="login" action="auth.php">
                                    ...
                                    <p class="mt-4 text-sm text-center">
                                        ...
                                        <a href="../../../pages/authentication/signup/register.php"
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-12 col-md-6 my-auto">
                            <div class="copyright text-center text-sm text-white text-lg-start">
                                ...
                                <a href="https://itconsultant.shuyshuys.repl.co/pages/kontak/teams.php"
                                    class="font-weight-bold text-white" target="_blank">Kelompok 2 Tim</a>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://itconsultant.shuyshuys.repl.co/pages/kontak/teams.php"
                                        class="nav-link text-white" target="_blank">Kelompok 2 Tim</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://itconsultant.shuyshuys.repl.co/pages/kontak/teams.php"
                                ...
                                <li class="nav-item">
                                    <a href="https://itconsultant.shuyshuys.repl.co/" class="nav-link text-white"
